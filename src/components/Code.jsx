...
function CodeGroupHeader({ title, children, selectedIndex }) {
  ...
  return (
    <div className="flex min-h-[calc(theme(spacing.12)+1px)] flex-wrap items-start gap-x-4 border-b border-zinc-700 dark:border-zinc-800  bg-zinc-800 dark:bg-transparent px-4 ">
      {title && (
